...
export const frenchText = `Il y a longtemps, la vie était dangereuse. Il y avait une petite ville dans le désert. Un homme appelé Marc y vivait. Le travail de Marc était de garder la ville en sécurité.
...
export const italianText = `Il Viaggio del Palloncino
