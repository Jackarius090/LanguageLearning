...
const Textarea = React.forwardRef(({ className, setHighlightedText, highlightedText, setTranslation, sendDanishClick, ...props }, ref) => {
...
const handleDanishClick = () => {
  ...
  useEffect(() => {
    sendDanishClick(handleDanishClick);
  }, [sendDanishClick]);
