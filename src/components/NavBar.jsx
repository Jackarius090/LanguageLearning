            ...
            <NavigationMenuContent>
                ...
                <li className="row-span-3">
                    <div className="flex items-center place-content-center h-full w-full select-none flex-col rounded-md bg-gradient-to-b from-muted/50 to-muted p-6 no-underline outline-none focus:shadow-md">
                        <img className="dark:brightness-75 size-12 mb-5" src="public/favicon-192x192.png" alt="" />
                ...
                <li>
                    <div onClick={handleChineseClick} className="block select-none space-y-1 rounded-md p-3 leading-none no-underline outline-none transition-colors hover:bg-accent hover:text-accent-foreground focus:bg-accent focus:text-accent-foreground">
                        <div className="text-sm font-medium leading-none">Chinese text</div>
                        <p className="line-clamp-2 text-sm leading-snug text-muted-foreground">
